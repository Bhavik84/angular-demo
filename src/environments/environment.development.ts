export const environment = {
  ...
  // Stagging
  BASE_PATH: 'https://alabern.namastech.com/',
  API_END_POINT: 'https://app.alabern.namastech.com/',
  IMAGE_URL: 'https://app.alabern.namastech.com/',
  IMAGE_URL_PROXY: 'https://app.alabern.namastech.com/proxy?url=',
  VIRTUAL_EXHIBITION_URL: 'https://virtualexhibition.alabern.namastech.com',
  ...
  ALLOWED_HOSTS: ['localhost', 'alabern.sctestingsite.com', 'alabern.namastech.com'],
  ...
  // VIRTUAL_EXHIBITION_URL: 'https://virtualexhibition.fotografiacatalunya.namastech.com',
  // DEFAULT_IMAGE_PATH: 'assets/images/No-Image-Placeholder.png',
